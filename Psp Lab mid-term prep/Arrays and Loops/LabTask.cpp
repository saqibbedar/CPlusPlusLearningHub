// Task 1: read array from user and first print reverse of it.
// Task 2: find the largest and smallest number in array
// Task 3: Check the occurrence of number and print its values
...
int main()
{
    ...
    cout<<"\nThis is reverse of 1st array:\n"; // it is just printing reverse not reversing actual values to do that we need to swap the values
